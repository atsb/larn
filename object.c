    ...
    int             typ;
{
    ...
    if (typ < 0 || typ >= MAXSCROLL)
        return(0);     /* be sure we are within bounds */
    scrollname[typ] = ' ';
    switch (typ)
    {
    case 0:
    ...
    case 4:
        ...
        return(0);     /* this one creates a monster  */
    ...
    case 8:
        oteleport(0);
        return(0);     /* teleportation */

    case 9:
        c[AWARENESS] += 1800;
        return(0);     /* expanded awareness   */

    case 10:
        c[HASTEMONST] += rnd(55) + 12;
        return(0);     /* haste monster */
    ...
    case 11:
        ...
        return(0);     /* monster healing */
    case 12:
        c[SPIRITPRO] += 300 + rnd(200);
        bottomline();
        return(0);     /* spirit protection */

    case 13:
        c[UNDEADPRO] += 300 + rnd(200);
        bottomline();
        return(0);     /* undead protection */
